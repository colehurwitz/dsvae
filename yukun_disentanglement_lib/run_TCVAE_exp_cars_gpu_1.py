...
def create_config(dim, beta, seed):
    config_name = '/hdd/dsvae/tcvae_models/cars3d/config/d_{}_b_{}.gin'.format(dim, beta)
    basefile = '/hdd/dsvae/tcvae_models/cars3d/config/base.gin'
    lines = []
...
for dim in dim_list:
    for beta in beta_list:
        for seed in seeds:
            ...
            train_output_dir = '/hdd/dsvae/tcvae_models/cars3d/train_output/{}'.format(exp_name)
            eval_output_dir = '/hdd/dsvae/tcvae_models/cars3d/eval_output/{}'.format(exp_name)
