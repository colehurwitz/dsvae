...
def create_config(dim, beta, seed):
    config_name = '/hdd/dsvae/tcvae_models/celeba10/config/d_{}_b_{}.gin'.format(dim, beta)
    basefile = '/hdd/dsvae/tcvae_models/celeba10/config/base.gin'
    lines = []
...
for dim in dim_list:
    for beta in beta_list:
        ...
        train_output_dir = '/hdd/dsvae/tcvae_models/celeba10/train_output/{}'.format(exp_name)
        eval_output_dir = '/hdd/dsvae/tcvae_models/celeba10/eval_output/{}'.format(exp_name)
